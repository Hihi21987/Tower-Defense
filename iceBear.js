class IceBear {
  ...
  constructor(x, y) {
    ...
    this.ug1Level = 0;
    this.ug1Label = "Colder Pongs";
    this.ug1Desc = [
      "Pings are slowed down longer and slower!",
      "Pings are slowed down even longer and slower!",
    ];
    this.ug1 = [2000, 3500, 5000];
    this.ug1Extra = [0.5, 1, 2];
    this.ug1Price = [150, 300, 500];

    // Stuff for second upgrade path
    this.ug2Level = 0;
    this.ug2Label = "Sharp Pongs";
    this.ug2Desc = ["Pongs will deal 2 damage!", "Pong will deal 4 damage!"];
    this.ug2 = [0, 2, 4];
    this.ug2Price = [150, 300, 500];

    // Stuff for third upgrade path
    this.ug3Level = 0;
    this.ug3Label = "Further Pongs";
    this.ug3Desc = [
      "Ice Bear can detect pings further away!",
      "Ice Bear can detect pings even further away!",
    ];
    this.ug3 = [50, 65, 80];
    this.ug3Price = [100, 150, 200];
    ...
    if (this.mode == "tower") {
      ...
      if (this.mouseHovered) {
        ...
        if (this.attacking) {
          ...
          image(iceBearIdle, -this.r * 2, -this.r * 2, this.r * 4, this.r * 4);
        }
      }
  ...
  update() {
    // Update upgrades
    this.slowLength = this.ug1[this.ug1Level];
    this.slowness = this.ug1Extra[this.ug1Level];
    this.attackDamage = this.ug2[this.ug2Level];
    this.attackRadius = this.ug3[this.ug3Level];
    
    this.attackSpeed = 1300; // stop removing this
